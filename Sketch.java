...
public class Sketch extends PApplet {
  ...
  */
  ...
  public void level2(){
    ...
    textSize(25);
    fill(255, 255, 255);
    text("Use WASD to control dad. (pro tip: if dad doesnt move, click the game window once ;) )", width / 2, 100);
    text("oh u only have 10 mins >:)", width / 2, 180);
    ...
    // Draw dad and make dad move based on WASD presses
      ...
      if(dadY < 260 || dadY > 277){
        ...
        if(elasped1 < dura1){
          ...
          fill(255);
          textSize(40);
          text("lol how did u even hit the wall???", width / 2, 80);
          text("Press Alt to restart lol", width / 2, 600);
      ...
      if(dadX >= 1040){
        ...
        image(imgMike, 0, 0);
        textSize(30);
        text("pov: dads reaction to u completing this level", width / 2, 70); 
    }
      }
      ...
      public void level3(){
        ...
        textSize(20);
        text("real portal", 100, 230);
        text("real portal", 1120, 430);
        ...
        textSize(30);
        fill(0, 0, 0);
        text("Get to the end of the road! >:) ", 980, 50);
        ...
        fill(0);
        textSize(20);
        text("No Jaywalking!", 100, 500);
        text("Penalty: jail lol", 100, 530);
        ...
        if(dadY1 < 250 && dadX1 > 170 || dadY1 > 390){
          ...
          fill(255);
          textSize(30);
          text("all u had to do was follow the road -_-", width / 2, 50);
          text("Press P to restart ._.", width / 2, 120);
        }
            if(keyPressed){
            if(key == 'p'){
              dadX1 = 30;
       ...
       if (state == 0) {
        textSize(30);
        text("Cop: Y were u jaywalking???", width / 2, 30);
        text("Choose either: 1. no clue OR 2. i do not care (Press 1 or 2)", width / 2, 100);
      }
      // If user chooses option 1, display 2 possible endings
        ...
        image(imgDadMad, 500, 440);
        textSize(30);
        text("Cop: ok u need to pay a $1 fine", width / 2, 30);
        text("Choose either: 1. pay fine OR 2. fight cop", width / 2, 100);
      } 
      ...
      // If user chooses option 2, display 2 possible endings
        ...
        image(imgDadMad, 500, 440);
        textSize(30);
        text("Cop: u rlly dont care that ur jaywalking??", width / 2, 30);
        text("Choose either: 1. care less OR 2. bribe cop", width / 2, 100);
        } 
        ...
        image(imgDadMad, 500, 440);
        textSize(30);
        text("BAD ENDING: YOU GOT ARRESTED... WOMP WOMP", width / 2, 30);
        text("u pulled out ur wallet just to realize you have no money", width / 2, 100);
        text("u got arrested for not paying a $1 fine LOL", width / 2, 170);
        text("You found the arrested over $1 fine ending!", width / 2, 240);
        }
        ...
        // If user chooses to fight the cop, display bad ending
          ...
          textSize(30);
          text("BAD ENDING: YOU GOT SHOT... WOMP WOMP", width / 2, 30);
          text("u tried to take the cops gun but he was too fast", width / 2, 100);
          text("u got shot and died on the scene", width / 2, 170);
          text("what were u even thinking smh... smooth brain", width / 2, 240);
          text("You found the shot to death ending!", width / 2, 310);
      } 
        ...
        // If user chooses to not care, display cutscene
          ...
          textSize(30);
          text("Cop: so u dont even care???", width / 2, 30);
          text("Press Alt to continue...", width / 2, 100);
      }
        ...
        // If user chooses to bribe cop, display bad ending
          ...
          image(imgDadMad, 500, 440);
          textSize(30);
          text("BAD ENDING: YOU GOT ARRESTED LOL... WOMP WOMP", width / 2, 30);
          text("u cared so little that u tried to bribe a cop", width / 2, 100);
          text("u realized u only had $10 and tried to give the cop $10", width / 2, 170);
          text("the cop didnt accept ur bribe and u got arrested", width / 2, 240);
          text("You found the bribery ending!", width / 2, 310);
      } 
        ...
        // If user chooses to not care, display good ending and let them continue to level 4
          ...
          image(imgDadMedium, 500, 440);
          textSize(30);
          text("Cop: k since u dont care and i dont, imma just let u go", width / 2, 30);
          text("GOOD ENDING: YOU DIDN'T GET ARRESTED!", width / 2, 200);
          text("hopefully it didnt take u too long to find the right ending", width / 2, 270);
          text("Press Alt to continue...", width / 2, 400);
      }
        }
      }
        ...
        public void cutScene4() {
          ...
          // Add final death scene 
            ...
            fill(0);
            textSize(50);
            text("YOU DIED... WOMP WOMP", width / 2, 150);
            textSize(30);
            text("lol imagine walkin onto a soccer field", width / 2, 250);
            text("and imagine being confused for the ball LOL", width / 2, 350);
            text("suiiiiiiiiiiiiiiiiiii", width / 2, 450);
            }
          }
          }
          ...
          public void lamboCar(){
            for (int i = 0; i < lamboCount; i++) {
              ...
              if(lamboHit){
                ...
                tankY[i] = -250;
                textSize(30);
                text("YOU DIED... WOMP WOMP", width / 2, 30);
                text("bruh there was literally a sign saying to not jaywalk smh...", width / 2, 100);
                text("also imagine being so big u take up the whole road LOL", width / 2, 170);
                text("we recommend not jaywalking and getting plowed by a lambo", width / 2, 240);
                text("Press P to restart...", width / 2, 310);
          ...
          public void Tank(){
            for(int i = 0; i < tankCount; i++){
              ...
              if(tankHit){
                ...
                text("YOU DIED... WOMP WOMP", width / 2, 30);
                text("bruh there was literally a sign saying to not jaywalk smh...", width / 2, 100);
                text("also imagine not seeing the tank smh", width / 2, 170);
                text("we recommend not jaywalking and getting plowed by a tank", width / 2, 240);
                text("Press P to restart...", width / 2, 310);
                imgDadDead.resize(250, 250);
                image(imgDadDead, 450, 350);
              }
            ...
            public void level4(){
                ...
                textSize(20);
                fill(0);
                text("stuck? hover ur mouse over", 140, 170);
                text("the card to buy hacks!", 130, 210);
                text("dont click mouse", width / 2, 20);
                ...
                if(dadX3 > 970 && dadY3 < 330 && dadY3 > 200){
                  ...
                  textSize(30);
                  fill(0);
                  text("what? how did u cross the road???", width / 2, 70);
                  text("yk that road was made to be impossible to cross right??", width / 2, 140);
                  text("congrats for getting across ig", 360, 210);
                  text("fyi that wasnt how u were supposed to beat the level LOLLLLL", width / 2, 280);
                  text("i hope it didnt take u too long to beat it LOL", width / 2, 350);
                  text("Press Ctrl to move on LOL...", width / 2, 580);
              ...
              public void Cheater(){
                ...
                textSize(30);
                fill(250, 17, 25);
                text("LOL u rlly thought u could cheat LOL", width / 2, 70);
                text("imagine tryin to buy hacks lol", width / 2, 140);
                text("im just gonna hope u moved ur mouse here by accident...", width / 2, 210);
                text("move ur mouse off this to continue...", width / 2, 600);
              }
              ...
              public void Karen(){
                ...
                textSize(30);
                fill(0);
                text("BAD ENDING: YOU WENT VIRAL FOR BEING A KAREN... WOMP WOMP", width / 2, 70);
                text("LOL no way bro just tried to speak to the manager", width / 2, 140);
                text("bruh imagine speaking to the manager cuz u cant jaywalk on a highway LOL", width / 2, 210);
                text("next time dont be such a karen LOL", width / 2, 280);
                fill(255, 255, 255);
                text("You found the Karen ending!", width / 2, 600);
              }
              ...
              public void Chrion(){
                for (int i = 0; i < chrionCount; i++) {
                  ...
                  if(chrionHit){
                    ...
                    textSize(30);
                    text("YOU DIED... WOMP WOMP", width / 2, 30);
                    text("bruh imagine tryin to cross a 4 lane road smh", width / 2, 100);
                    text("we recommend not jaywalking on a highway", width / 2, 170);
                    text("Press Alt to restart...", width / 2, 310);
                    imgDadDead.resize(250, 250);
                    image(imgDadDead, 450, 350);
                  }
              ...
              public void Creeper(){
                for (int i = 0; i < creeperCount; i++) {
                  ...
                  if(creeperHit){
                    ...
                    textSize(30);
                    text("YOU DIED... WOMP WOMP", width / 2, 30);
                    text("uhh well that was interesting", width / 2, 100);
                    text("how did u even get hit by a creeper???", width / 2, 170);
                    text("Press Alt to restart...", width / 2, 310);
                    imgDadDead.resize(250, 250);
                    image(imgDadDead, 450, 350);
                  }
              ...
              public void ezEnding(){
                imgPog.resize(1200, 700);
                  ...
                  textSize(30);
                  fill(255);
                  text("YOOO u found the ez ending!!!", width / 2, 70);
                  text("congrats for finding this!", width / 2, 140);
                  text("Press Ctrl to continue!!", width / 2, 210);
